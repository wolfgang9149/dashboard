    ...
    <>
      <ResponsiveContainer width='100%' height={385}>
        ...
        >
          ...
          />
          <Line type='monotone' dataKey='spectV' name='Violet' stroke='#8F00FF' dot={false}/>
          <Line type='monotone' dataKey='spectB' name='Blue' stroke='#1c53e7' dot={false}/>
          <Line type='monotone' dataKey='spectG' name='Green' stroke='#2e6930' dot={false}/>
          <Line type='monotone' dataKey='spectY' name='Yellow' stroke='#FFFF00' dot={false}/>
          <Line type='monotone' dataKey='spectD' name='Orange' stroke='#FFA500' dot={false}/>
          <Line type='monotone' dataKey='spectR' name='Red' stroke='#FF0000' dot={false}/>
        </LineChart>
      </ResponsiveContainer>
    </>
  );
